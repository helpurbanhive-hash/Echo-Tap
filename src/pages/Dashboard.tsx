...
export default function Dashboard() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!business && isProfileLoaded && userProfile?.businessId) {
        setLoadingTimeout(true);
      }
    }, 10000); // 10 seconds timeout
    return () => clearTimeout(timer);
  }, [business, isProfileLoaded, userProfile]);
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-slate-100">
          ...
          <p className="text-slate-600 mb-8">
            We couldn't find a business associated with your account. Please contact your administrator or set up your business in settings.
          </p>
          <div className="flex flex-col gap-3">
            ...
            <button 
              ...
              className="w-full py-3 bg-slate-50 text-slate-600 rounded-xl font-semibold hover:bg-slate-100 transition-all"
            >
              Sign Out
            </button>
          </div>
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-slate-50">
        <div className="text-center p-8">
          ...
          {loadingTimeout && (
            <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-amber-700 text-sm max-w-xs mx-auto">
              <p className="mb-3">This is taking longer than expected. There might be a connection issue.</p>
              <button 
    ...
    <div className="flex-1 overflow-y-auto bg-slate-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-[0_2px_6px_rgba(0,0,0,0.08)] border border-slate-200 p-6"
        >
